            ...
            <div class="box box-primary box-solid">
                <div class="box-header box-header-background with-border">
                    ...
                    <div class="box-tools pull-right">                        
                        <a href="{{url('admin/categories/create')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add</a>  
                    </div>
                </div>
                ...
                <div class="box-body table-responsive">
                    <table id="category-table" class="table table-bordered table-hover">
                        ...
                        <input type="hidden" name="data_table_name" id="data_table_name" value="category-table">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>S NO</th>
...
$(document).ready(function () {
    ...
    if ($('#category-table').length > 0) {
        var tableData = $('#category-table').DataTable({
            processing: true,
            serverSide: true,
